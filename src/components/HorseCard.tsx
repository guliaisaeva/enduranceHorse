...
interface Horse {
  ...
  breed: string;
  age: number;
  sex: "Stallion" | "Gelding" | "Mare" | "Colt" | "Filly";
}

const tagColorMap: Record<Horse["sex"], string> = {
  Stallion: "bg-blue-700",
  Gelding: "bg-blue-400",
  Mare: "bg-pink-600",
  Colt: "bg-purple-500",
  Filly: "bg-purple-300",
...
const HorseCard = ({
  ...
  return (
    <BaseCard
      ...
      subtitle={`${t("breed")}: ${horse.breed}`}
      description={`${t("age")}: ${horse.age}`}
      tagText={horse.sex}
      tagColor={tagColorMap[horse.sex] || "bg-gray-500"}
